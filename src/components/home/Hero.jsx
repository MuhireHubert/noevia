            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-20 md:grid-cols-2 md:py-28">
                <div>
                    ...
                    <h1 className="font-display text-4xl leading-tight md: text-5xl">
                        A warm cup and a quiet corner, right at Gahanga.
                    </h1>
                    <p className="mt-5 max-w-md text-latte-200/90">
                    Noevia Cafe serves small-batch coffee and fresh-baked pastries in a space built for lingering - come read, work or catch up with friends.
                    </p>
                ...
                <div className="relative">
                    ...
                    alt="Latte art in a wam-toned cafe"
