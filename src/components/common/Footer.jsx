    ...
    return (
        <footer className = "mt-24 bg-espresso-950 text-latte-200">
            <div className = "mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-3">
                <div>
                <h3 className = "font-dispaly text-2xl text-cream">Noevia</h3>
                <p className = "mt-3 max-w-xs text-sm text-latte-300/80">
                Small-batch coffee, fresh pastries and a warm place to sit for a
                while.
                </p>
            </div>
            ...
            <div>
                ...
                <p>At Engen Gahanga: KK 15 Rd</p>
                <p>Gahanga, road to Nyamata</p>
        ...
        <div className="flex flex-col items-center gap-2 border-t border-t border-latte-300/10 px-45 py-5 text-center text-xs text-latte-300/60">
