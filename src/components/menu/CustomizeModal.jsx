...
// Builds the initial selection state: single-choice groups default to
// their first choice, multi-choice groups default to nothing selected.
                    ...
                    <button
                      ...
                      className={`rounded-full border px-3.5 py-1.5 text-sm transition-colors ${
                        active
                          ...
                          : "border-espresso-800/20 text-espresso-800 hover:bg-latte-200"
                      }`}
                    >
                      {choice.label}
                      {choice.priceDelta > 0 && (
