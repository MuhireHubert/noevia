...
export default function contact() {
    ...
    return (
        <div className ="mx-auto max-w-5xl px-5 py-16">
            ...
            <div className="mt-10 grid gap10 md:grid-cols-2">
                <div>
                    {submitted ? (
                        <div className="rounded-2xl border border-sage/30 bg-sage/10 p-6 text-espresso-900">
                        <p className = "font-semibold">Thank you! We got your message!
                        </p>
                        ...
                        <form onSubmit = {handleSubmit} className = "space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                    type = "date"
                                    className = "2-full rounded-xl border border-espresso-800/20 bg-latte-100 px-4 py-2.5 outline-none focus:border-clay"
                                    />
                                </div>
                                <div>
                                    <label className = "mb-1 block text-sm font-medium text-espresso-800">
                ...
                <div className = "space-y-4">
                    <div className="overflow-hidden rounded-2xl bg-latte-100 p-6 text-sm text-espresso-800/90">
                    <p>Kicukiro, Gahanga, KK 15 Rd (At Engen Station on the Gahanga - Nyamata Road)</p>
                    <p className = "mt-1">+250 781 681 538</p>
