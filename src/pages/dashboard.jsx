        ...
        <StaffGate>
            <div className = "mx-auto max-w-5xl px-5 py-16">
                <div className = "flex flex-wrap items-start justify-between gap-3">
                    <div>
                        <h1 className = "font-display text-4xl text-espresso-900">Staff Dsshboard</h1>
                        <p className = "mt-2 ext-espresso-700/80">
                        Track incoming orders and manage what is on the menu
                        </p>
                    </div>
                ...
                <div className = "mt-8 flex gap-2 border-espresso-800/10 border-b">
                {tabs.map((t) => (
                    <button
                    key={t}
                    onClick={() => setTab(t)}
