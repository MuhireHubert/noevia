...
export function CartProvider({ children }) {
  ...
  // item: { cartId, productId, name, image, basePrice, unitPrice, qty, options: [{groupLabel, choiceLabel, priceDelta}] }

  // `selectedOptions` (optional): [{ groupId, groupLabel, choiceIds: [...], choiceLabels: [...], priceDelta }]
